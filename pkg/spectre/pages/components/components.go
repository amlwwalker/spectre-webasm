...
//	return pages.NewPage("Badges", "Badges are often used as unread number indicators", "/documents/badges.md", []app.UI{},
...
//	return pages.NewPage("Accordions", "Accordions are used to toggle sections of content", "/documents/accordions.md",
	...
	return app.Div().Class("container").Body(
		...
		layouts.SideBar(
			components.Accordion(
				...
				markdown.NewRemoteMarkdownDoc().Src("/documents/modals.md"),
			),
		),
	)
}
...
//	return pages.NewPage("Tabs", "Tabs group information together onto different tabs based on content or context", "/documents/tabs.md",
...
//}
//
//func (h *CustomComponents) Render() app.UI {
//	return components.CustomComponent("ComponentA", map[string]interface{}{
...
//	return pages.NewPage("Chips", "Chips are complex entities in small blocks.", "/documents/chips.md",
//		layouts.FlexBox("80%",
...
//		}),
//	}
//	return pages.NewPage("Breadcrumbs", "breadcrumbs help show and navigate around a site", "/documents/breadcrumbs.md",
...
//	return pages.NewPage("Empty States", "Empty states/blank slates are commonly used as placeholders for first time use, empty data and error screens.", "/documents/empty.md",
//		app.Br(),
