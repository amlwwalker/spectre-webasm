...
func (h *HeroPage) Render() app.UI {
	return pages.NewPage("Hero", "Heros are large title blocks", "/documents/heros.md",
...
//
//func (h *HeroPage) Render() app.UI {
//	return pages.NewPage("Tiles", "Tiles are repeatable or embeddable information blocks.", "/documents/tiles.md",
